...
export default function AppLayout({
  ...
  useEffect(() => {
    ...
    // Allow access to the root page, which handles its own redirection.
    if (pathname === '/') return;
    
    // For vendor users, always redirect to their dashboard if they are not already in their area
    ...
    const isAllowed = allowedPaths.some(p => {
        ...
        // This makes sure /requisitions/[id]/edit is also allowed.
        const dynamicRouteRegex = new RegExp(`^${p}/.+$`);
        return dynamicRouteRegex.test(currentPath);
    });
