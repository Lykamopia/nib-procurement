      ...
      <Card className="p-4 sm:p-6 md:p-8">
        <CardHeader className="flex flex-row items-start justify-between space-y-0">
          <div className='flex items-center gap-2'>
            <Image src="/logo.png" alt="Nib InternationalBank Logo" width={40} height={40} className="size-10" />
            <div>
                <h2 className="text-2xl font-bold">Nib InternationalBank</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                  <h3 className="font-semibold text-muted-foreground mb-2">SHIP TO</h3>
                   <div className="not-italic text-card-foreground">
                      <p className="font-bold text-lg">Nib InternationalBank</p>
