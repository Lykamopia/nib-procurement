...
const seedData: AppData = {
    ...
    users: [
        ...
        { id: '15', name: 'Procurement Manager', email: 'manager.proc@example.com', password: 'password123', role: 'ManagerProcurement', departmentId: 'DEPT-2', department: 'Operations', approvalLimit: 200000 },
        { id: '16', name: 'Supply Chain Director', email: 'director.supply@example.com', password: 'password123', role: 'DirectorSupplyChain', departmentId: 'DEPT-2', department: 'Operations', approvalLimit: 1000000 },
        { id: '17', name: 'VP of Resources', email: 'vp.resources@example.com', password: 'password123', role: 'VPResources', departmentId: 'DEPT-2', department: 'Operations', approvalLimit: 5000000 },
