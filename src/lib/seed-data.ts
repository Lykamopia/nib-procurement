...
const seedData: AppData = {
    ...
    users: [
        ...
        { id: '3', name: 'Charlie', email: 'charlie@example.com', password: 'password123', role: 'ProcurementOfficer', departmentId: 'DEPT-2', department: 'Operations', approvalLimit: 0, managerId: '15' },
        ...
        { id: '9', name: 'Fiona', email: 'fiona@example.com', password: 'password123', role: 'CommitteeMember', departmentId: 'DEPT-1', department: 'Design', approvalLimit: 0 },
        { id: '10', name: 'George', email: 'george@example.com', password: 'password123', role: 'CommitteeMember', departmentId: 'DEPT-3', department: 'IT', approvalLimit: 0 },
        ...
        { id: '13', name: 'Irene', email: 'irene@example.com', password: 'password123', role: 'CommitteeAMember', departmentId: 'DEPT-5', department: 'Finance', approvalLimit: 0 },
        { id: '14', name: 'Jack', email: 'jack@example.com', password: 'password123', role: 'CommitteeBMember', departmentId: 'DEPT-4', department: 'Marketing', approvalLimit: 0 },
        { id: '15', name: 'Procurement Manager', email: 'manager.proc@example.com', password: 'password123', role: 'ManagerProcurementDivision', departmentId: 'DEPT-2', department: 'Operations', approvalLimit: 200000 },
        { id: '16', name: 'Supply Chain Director', email: 'director.supply@example.com', password: 'password123', role: 'DirectorSupplyChainandPropertyManagement', departmentId: 'DEPT-2', department: 'Operations', approvalLimit: 1000000 },
        { id: '17', name: 'VP of Resources', email: 'vp.resources@example.com', password: 'password123', role: 'VPResourcesandFacilities', departmentId: 'DEPT-2', department: 'Operations', approvalLimit: 5000000 },
